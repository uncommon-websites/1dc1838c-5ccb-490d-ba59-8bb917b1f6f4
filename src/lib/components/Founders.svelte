<section class="px-6 py-12 bg-[#f5f5f5]">
  <div class="max-w-[1400px] mx-auto relative rounded-sm overflow-hidden bg-[#0a2533] h-[500px] flex flex-col justify-center items-center text-center px-6">
    ...
    <img 
      src="/generated/image-diverse-team-of-professionals-collaborat-1765404423027-1.webp" 
    ...
    <div class="relative z-10 max-w-2xl">
      ...
      <p class="text-gray-400 text-lg mb-10 leading-relaxed">
        Hanson and Martin worked at EQT where they used the reports Inon produced at Bain. Now they're building the future of market research together—combining Blackstone and BCG expertise with cutting-edge AI.
      </p>
